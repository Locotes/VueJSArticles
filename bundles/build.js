...
/***/ function(module, exports, __webpack_require__) {
	...
	var routes = [{ path: '/', component: _list2.default }, { path: '/article/:url', component: _article2.default, props: true }];
	...
	var app = new _vue2.default({
	  ...
	  computed: {},
	  components: {
	    'newsList': _list2.default,
	    'newsItem': _item2.default,
	    'newsArticle': _article2.default
	  },
	  methods: {}
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _vuexPersistedstate = __webpack_require__(6);
	...
	exports.default = new _vuex2.default.Store({
	    ...
	    plugins: [(0, _vuexPersistedstate2.default)({ storage: window.sessionStorage })]
	});
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	(function (global, factory) {
	   true ? module.exports = factory(__webpack_require__(7), __webpack_require__(9)) :
...
/***/ function(module, exports) {
	...
	var mutations = exports.mutations = {
	    setCode: function setCode(state, input) {
	        state.code = input;
	    },
	    setItems: function setItems(state, input) {
	        state.items = input;
	    },
	    setBorderRadius: function setBorderRadius(state, input) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	Component.options.__file = "D:\\Websites\\VueJSArticles\\assets\\js\\components\\news\\list.vue"
	...
	if (false) {(function () {
	  ...
	  module.hot.accept()
	  if (!module.hot.data) {
	    hotAPI.createRecord("data-v-258ba68c", Component.options)
	  } else {
	    hotAPI.reload("data-v-258ba68c", Component.options)
	  }
	})()}
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    created: function created() {
	        this.getItems(itemsToLoad, 0);
	    },
	    methods: {
	        getItems: function getItems(total, start) {
	            var vm = this;

	            apiService.getNewsItems().then(function (data) {
	        ...
	        moreItemsToLoad: function moreItemsToLoad() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {
	  ...
	  module.hot.accept()
	  if (!module.hot.data) {
	    hotAPI.createRecord("data-v-1b862e81", Component.options)
	  } else {
	    hotAPI.reload("data-v-1b862e81", Component.options)
	  }
	})()}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {
	  module.hot.accept()
	  if (module.hot.data) {
	     require("vue-hot-reload-api").rerender("data-v-1b862e81", module.exports)
	  }
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {
	  module.hot.accept()
	  if (module.hot.data) {
	     require("vue-hot-reload-api").rerender("data-v-258ba68c", module.exports)
	  }
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {
	  ...
	  module.hot.accept()
	  if (!module.hot.data) {
	    hotAPI.createRecord("data-v-66442a78", Component.options)
	  } else {
	    hotAPI.reload("data-v-66442a78", Component.options)
	  }
	})()}
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    staticClass: "article-paragraph"
	  }, [_vm._v(_vm._s(_vm.article.description))])])], 1)
	},staticRenderFns: []}
	module.exports.render._withStripped = true
	if (false) {
	  module.hot.accept()
	  if (module.hot.data) {
	     require("vue-hot-reload-api").rerender("data-v-66442a78", module.exports)
	  }
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ApiService = function () {
	    ...
	    (0, _createClass3.default)(ApiService, [{
	        ...
	        key: 'getNewsItem',
	        value: function getNewsItem(url) {
	            var defer = _q2.default.defer();

	            this.getNewsItems().then(function (items) {
	                defer.resolve(items.find(function (i) {
	                    return i.url === url;
	                }));
	            });
